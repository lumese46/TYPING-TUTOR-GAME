...
public class GamePanel extends JPanel implements Runnable {
      ...
      private FallingWord[]  Hword;
		...
		GamePanel(FallingWord[] words,FallingWord[] Hword, int maxY,	
				 AtomicBoolean d, AtomicBoolean s, AtomicBoolean w) {
			this.words=words; //shared word list
         this.Hword = Hword; //HungryWord
		...
		public void paintComponent(Graphics g) {
		   ...
		   //draw the words
            ...
            //g.drawString(words[0].getWord(),words[0].getX()+borderWidth,words[0].getY());
           g.setColor(Color.green);
          
           g.drawString(Hword[0].getWord(),Hword[0].getX()+borderWidth,240); 
		...
		synchronized public int getValidXpos() {
    ...
    /* synchronized public int getValidYpos() {
