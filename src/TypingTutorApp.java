...
//shared class variables
   ...
   // falling hungryword
   static FallingWord[] Hword = new FallingWord[1] ;
   
	static WordMover[] wrdShft;
   // thread for hungryWord
   static HungryWordMover hWrdShft;
  ...
  public static void createHungryWordMoverThread(){
       score.reset();
       Hword[0] = new FallingWord(dict.getNewWord(),0 ,yLimit);
       hWrdShft = new HungryWordMover(Hword,dict,score,startLatch,done,pause);
	...
	public static void createWordMoverThreads() {
	    ...
	    for (int i=0;i<noWords;i++) {
	    		wrdShft[i] = new WordMover(words[i],Hword,dict,score,startLatch,done,pause);
	    }
...
public static void main(String[] args) {
      ...
      Hword[0] = new FallingWord(dict.getNewWord(), yLimit/2,yLimit);
		wrdShft = new WordMover[noWords]; //array for the threads that animate the words
      
		CatchWord.setHWords(Hword);// this is for hungry word 
